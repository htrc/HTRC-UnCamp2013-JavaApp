...
public class UnCampVolumeDemo {	
	...
	private static final String VOLUME_URL = "/volumes";	
	...
	public static void main(String[] args) throws Exception {
		if (args.length < 4) {
			System.out.println("UnCampVolumeDemo <client id> <client secret> <solr query string> <zip file name> [concat]");
			System.exit(-1);
		}
		...
		try {
			...
			InputStream responseStream = getDataFromDataAPI(DATA_API_ENDPOINT, VOLUME_URL, volumeList, token, concat);
